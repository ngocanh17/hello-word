...
<html lang="en">
    <head>
        ...
        <title>Trang quản trị người đăng kí khóa học</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quản trị người đăng kí khóa học</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Quản trị hệ thống</a></li>
                            <li class="breadcrumb-item active">Quản trị người đăng kí khóa học</li>
                        </ol>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Khóa học đăng kí</th>
                            ...
                            <?php  
                                ...
                                $ket_noi = mysqli_connect("localhost","root","","devzone.db");
                                 ...
                                 $sql= "
                                            ...
                                            ORDER BY dang_ki_hoc_id DESC";

                                  //3. 
                                  $noi_dung_dang_ki= mysqli_query($ket_noi,$sql);
                                  //4.
                                  $i = 0;
                                  while($row = mysqli_fetch_array($noi_dung_dang_ki))
                                  {
                            ...
                            ;?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo $row["khoa_hoc"];?></td>
                                            <td style="text-align: center;"><?php echo $row["loi_nhan"];?></td>
                                            <td style="text-align: center;"><?php echo $row["ngay_gui"];?></td>
                                            <td style="text-align: center;"><a href="dang_ki_hoc_xoa.php?id=<?php echo $row["dang_ki_hoc_id"];?>">Xóa</td>
                                        </tr>
                                    ...
                                    <?php  
                                      ...
                                      //5. dong lai ket noi khi sdung xong
