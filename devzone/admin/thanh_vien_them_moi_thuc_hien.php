...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <?php 
            ...
            $sql = "
           INSERT INTO `tbl_thanh_vien` (`thanh_vien_id`, `ten_thanh_vien`, `email_thanh_vien`, `so_dien_thoai`, `anh`, `facebook`, `ghi_chu`) VALUES (NULL, '".$ten_thanh_vien."', '".$email_thanh_vien."', '".$so_dien_thoai."', '".$hinh_anh."', '".$facebook."', '".$ghi_chu."');
            ";
            ...
            echo "
                <script type='text/javascript'>
                    window.alert('Bạn đã thêm mới thành viên thành công');
