...
<html lang="en">
    <head>
        ...
        <title>Trang quản trị liên hệ</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <?php  
                                ...
                                $ket_noi = mysqli_connect("localhost","root","","devzone.db");
                                 ...
                                 $sql= "
                                  ...
                                  //4.
                                  $i = 0;
                                  while($row = mysqli_fetch_array($noi_dung_lien_he))
                                  {
                            ...
                            ;?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo $row["noi_dung"];?></td>
                                            <td style="text-align: center;"><?php echo $row["ngay_gui"];?></td>
                                            <td style="text-align: center;"><a href="lien_he_xoa.php?id=<?php echo $row["lien_he_id"];?>">Xóa</td>
                                        </tr>
