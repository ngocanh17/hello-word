...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
	    <?php 
            ...
            $sql = "
                      INSERT INTO `tbl_blog` (`blog_id`, `tieu_de`, `mo_ta`, `noi_dung`, `hinh_anh`, `nguoi_viet`, `ngay_dang`, `so_lan_doc`) VALUES (NULL, '".$tieu_de."', '".$mo_ta."', '".$noi_dung."', '".$hinh_anh."', '".$nguoi_viet."', current_timestamp(), '0'); 
                      ";
            // echo $sql; exit();
