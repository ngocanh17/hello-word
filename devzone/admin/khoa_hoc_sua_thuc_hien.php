...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <?php         
            ...
            if($anh_khoa_hoc == NULL) {             
                $sql = "
                    UPDATE `tbl_khoa_hoc` 
                    SET   `ten_khoa_hoc`='".$ten_khoa_hoc."',`hinh_thuc`='".$hinh_thuc."',`buoi_hoc`='".$buoi_hoc."',`thoi_gian`='".$thoi_gian."',`gia`='".$gia."',`mo_ta`='".$mo_ta."'
                    WHERE `tbl_khoa_hoc`.`khoa_hoc_id`= '".$ten_khoa_hoc_id."'
                    ";
                    
            } else {           
                $sql = "
                    UPDATE `tbl_khoa_hoc` 
                    SET  `ten_khoa_hoc`='".$ten_khoa_hoc."',`hinh_thuc`='".$hinh_thuc."',`buoi_hoc`='".$buoi_hoc."',`thoi_gian`='".$thoi_gian."',`gia`='".$gia."', anh_khoa_hoc ='".$anh_khoa_hoc."',`mo_ta`='".$mo_ta."'
                    WHERE `tbl_khoa_hoc`.`khoa_hoc_id`= '".$ten_khoa_hoc_id."'
                    ";                
            }
