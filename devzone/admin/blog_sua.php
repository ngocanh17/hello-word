                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $row = mysqli_fetch_array($noi_dung_sua)
                                ;?>
                                <form method="POST" action="blog_sua_thuc_hien.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="file" class="form-control" id="txtHinhAnh" name="txtHinhAnh" placeholder="Ảnh đính kèm bài viết" value="<?php echo $row['hinh_anh'];?>" />
                                        <label for="txtHinhAnh">Ảnh đính kèm bài viết</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="txtMoTa" name="txtMoTa" placeholder="Mô tả nội dung bài viết" value="<?php echo $row['mo_ta'] ;?>" />
                                        <label for="txtMoTa">Mô tả</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtNoiDung" name="txtNoiDung" placeholder="Nội dung chính của bài viết" value="<?php echo $row['noi_dung'] ;?>" />
                                        <label for="txtNoiDung">Nội dung chính của bài viết</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtNguoiViet" name="txtNguoiViet" placeholder="Người viết" value="<?php echo $row['nguoi_viet'] ;?>" />
